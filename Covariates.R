...
{#** section 8.6 HEI  ####
    ...
    HEI=read.table("./data/NHANESIII/hei.dat",sep=",",fill=T)
    ...
    load("./data_eCM/III_baseline.Rdata")
...
{#** section 8.10 Diabetes ####
    {#*** section 8.10.1 Data Collation ####
      lab=read.table("./data/NHANESIII/lab.dat",sep=",",fill=T)
      #HbA1c(%) > 6.5
      lab$SEQN<-as.numeric(substring(lab$V1,1,5))
    ...
    {#** section 8.10.4 random blood glucose diagnosis ####
    ...
    {#** section 8.10.5 two-hour OGTT blood glucose diagnosis ####
    ...
    {#** section 8.10.6 Use of diabetes medication or insulin diagnosis ####
    ...
    Covariates_III_10<-merge(Covariates_III_9,DM_III,by="SEQN",all.x = T)
    record<-ls()
    rm(list=record[-which(record=='Covariates_III_1'|record=='Covariates_III_2'|
                            record=='Covariates_III_3'|record=='Covariates_III_4'|
                            record=='Covariates_III_5'|record=='Covariates_III_6'|
...
{#* section 8.11  CVD ####
  ...
  Covariates_III_11<-merge(Covariates_III_10,CVD_III,by="SEQN",all.x = T)
  record<-ls()
  rm(list=record[-which(record=='Covariates_III_1'|record=='Covariates_III_2'|
                          record=='Covariates_III_3'|record=='Covariates_III_4'|
                          record=='Covariates_III_5'|record=='Covariates_III_6'|
...
save(Covariates_III,file="./data_eCM/covariates_III.Rdata")
...
{#** section 9.6 HEI  ####
    ...
    load("./data_eCM/CON1_baseline.Rdata")
...
{#** section 9.10 Diabetes ####
  DM_CON1<-diag_DM(told = T,HbA1c = T,fast_glu = T,OGTT2 = T,
    ...
    Covariates_CON1_10<-merge(Covariates_CON1_9,DM_CON1,by="SEQN",all.x = T)
    record<-ls()
    rm(list=record[-which(record=='Covariates_CON1_1'|record=='Covariates_CON1_2'|
                            record=='Covariates_CON1_3'|record=='Covariates_CON1_4'|
                            record=='Covariates_CON1_5'|record=='Covariates_CON1_6'|
...
{#* section 9.11 CVD ####
    ...
    nhs_tsv("mcq")[c(1:3)]
    CVD_CON<-nhs_read(nhs_tsv("mcq")[c(1:3)],'mcq160b','mcq160c','mcq160d','mcq160e','mcq160f',Year = F,codebook = F)
    colnames(CVD_CON)<-c('SEQN','heart_failure','coronary_heart_disease','angina','heart_attack','stroke')
    rownames(CVD_CON)<-CVD_CON$SEQN
    CVD_CON[CVD_CON==1]<-"YES"
    CVD_CON[CVD_CON==2]<-"NO"
    CVD_CON[CVD_CON==8]<-NA
    CVD_CON[CVD_CON==9]<-NA
    CVD_CON$SEQN<-rownames(CVD_CON)
    CVD_CON$CVD[CVD_CON$heart_failure=="NO"|CVD_CON$coronary_heart_disease=="NO"|
                  CVD_CON$angina=="NO"|CVD_CON$heart_attack=="NO"|CVD_CON$stroke=="NO"]<-"NO"
    CVD_CON$CVD[CVD_CON$heart_failure=="YES"|CVD_CON$coronary_heart_disease=="YES"|
                  CVD_CON$angina=="YES"|CVD_CON$heart_attack=="YES"|CVD_CON$stroke=="YES"]<-"YES"
    CVD_CON<-CVD_CON[,c('SEQN','CVD')]
  Covariates_CON1_11<-merge(Covariates_CON1_10,CVD_CON,by="SEQN",all.x = T)
  record<-ls()
  rm(list=record[-which(record=='Covariates_CON1_1'|record=='Covariates_CON1_2'|
                          record=='Covariates_CON1_3'|record=='Covariates_CON1_4'|
                          record=='Covariates_CON1_5'|record=='Covariates_CON1_6'|
...
{#** section 9.15 Time since diabetes diagnosis  ####
    ...
    {#*** section 9.15.2 Time since diabetes diagnosis-DIQ  ####
      #9900
      duration_year_CON<-nhs_read(nhs_tsv("DIQ")[1:3],"DIQ040G:DIQ040G","DIQ040Q:DIQ040Q","DID040G:DIQ040G","DID040Q:DIQ040Q",nhs_tsv("DEMO")[1:3],"RIDAGEYR:Age",Year = F,codebook = F)
...
save(Covariates_CON1,file="./data_eCM/Covariates_CON1.Rdata")
...
{#** section 10.6 HEI  ####
    ...
    colnames(CON_HEI)[1]<-"SEQN"
    load("./data_eCM/CON2_baseline.Rdata")
...
{#** section 10.10 Diabetes ####
  ...
  colnames(DM_CON2)<-c("SEQN","T2D")
    Covariates_CON2_10<-merge(Covariates_CON2_9,DM_CON2,by="SEQN",all.x = T)
    record<-ls()
    rm(list=record[-which(record=='Covariates_CON2_1'|record=='Covariates_CON2_2'|
                            record=='Covariates_CON2_3'|record=='Covariates_CON2_4'|
                            record=='Covariates_CON2_5'|record=='Covariates_CON2_6'|
...
{#** section 10.11 CVD ####
  CVD_CON<-nhs_read(nhs_tsv("mcq")[c(6:9)],'mcq160b','mcq160c','mcq160d','mcq160e','mcq160f',Year = F,codebook = F)
  colnames(CVD_CON)<-c('SEQN','heart_failure','coronary_heart_disease','angina','heart_attack','stroke')
  rownames(CVD_CON)<-CVD_CON$SEQN
  CVD_CON[CVD_CON==1]<-"YES"
  CVD_CON[CVD_CON==2]<-"NO"
  ...
  CVD_CON$CVD[CVD_CON$heart_failure=="YES"|CVD_CON$coronary_heart_disease=="YES"|
                CVD_CON$angina=="YES"|CVD_CON$heart_attack=="YES"|CVD_CON$stroke=="YES"]<-"YES"
  CVD_CON<-CVD_CON[,c('SEQN','CVD')]
  Covariates_CON2_11<-merge(Covariates_CON2_10,CVD_CON,by="SEQN",all.x = T)
  record<-ls()
  rm(list=record[-which(record=='Covariates_CON2_1'|record=='Covariates_CON2_2'|
                          record=='Covariates_CON2_3'|record=='Covariates_CON2_4'|
                          record=='Covariates_CON2_5'|record=='Covariates_CON2_6'|
...
save(Covariates_CON2,file="./data_eCM/Covariates_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
{#* section 11.2 CRP  ####
  ...
  save(CRP,file="./data_eCM/CRP.Rdata")
}
...
{#*** section 12.1 NHANES III  ####
  ...
  save(Weight_III,file="./data_eCM/Weight_III.Rdata")
}
{#*** section 12.2 NHANES 1999-2004  ####
  ...
  save(Weight_CON1,file="./data_eCM/Weight_CON1.Rdata")
}
{#*** section 12.3 NHANES 2009-2014  ####
  load(file="./data/covariates/CON_covariates_09.Rdata")
  ...
  save(Weight_CON2,file="./data_eCM/Weight_CON2.Rdata")
}
...
{#* section 13.4 merge all data ####
  ...
  save(All_data,file="./data_eCM/All_data.Rdata")
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 14. Data clearn <<<<< ####

load(file="./data_eCM/All_data.Rdata")
table(All_data$T2D)
All_data$T2D_status[All_data$T2D=="No T2D"]<-"NO"
All_data$T2D_status[All_data$T2D=="T2D"]<-"YES"
All_data$T2D_status<-factor(All_data$T2D_status,
                              levels = c("NO","YES"))
table(All_data$T2D_status)
...
All_data$HbA1c<-NULL
All_data$Br_diabetes_status<-NULL
...
Clearn_data<-All_data[,c("ID","PD_diagnosis","Periodontitis_diagnosis","CAL_mean","PPD_mean","DMFT",
                         ...
                         "Age","BMI","WBC","Gender","Race_ethnicity","Education_levels","PIR","Health_insurance","SEI",
                         "Smoking_status","Drinking_status","Physical_status","HEI",
                         "HPL_status","HTN_status","CVD_status","Cancer_status","T2D_status",
...
colname<-c("ucod_leading","Physical_status","HEI","HPL_status","HTN_status","CVD_status","Cancer_status","sdmvpsu","sdmvstra")
Characters<-colApply(Clearn_data,colname, as.factor)

save(Characters,file="./data_eCM/Characters.Rdata")
